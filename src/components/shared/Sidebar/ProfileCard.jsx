...
export default function ProfileCard() {
  return (
    <section className="w-[98%] p-2 xl:p-8 mb-4 flex flex-col justify-center items-center border-b border-slate-300/55">
        ...
        <h3 className="text-md md:text-xl font-semibold text-slate-100 mb-2">Blake Lockman</h3>
        <span className="text-slate-300 text-sm md:text-md block">blakelockman33@gmail.com</span>
    </section>
  )
}
